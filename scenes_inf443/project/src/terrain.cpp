...
static vec2 p_i[23] = { {-100, 0}, {-88, -25}, {-76, -40}, {-64, -55}, {-52, -65}, {-40, -60}, {-28, -45}, {-16, -30}, {-4, -15}, {8, -30}, {20, -45}, {32, -60},{37, 33.5}, {44, 37}, {51, 40.5}, {58, 44}, {65, 47.5}, {72, 51}, {79, 54.5}, {86, 58}, {93, 61.5}, {100, 65},{100,100}

};

static float h_i[23] = { 19.72f, 36.65f, 12.59f, 45.96f, 4.29f, 39.53f, 18.37f, 29.79f, 8.36f, 43.83f, 2.54f, 27.96f,-1.7f, -1.2f, -0.8f, -2.0f, -1.4f, -3.0f, -2.1f, -1.3f, -1.9f, -1.3f,-40.0f


};

static float sigma_i[23] = { 21.15f, 19.32f, 10.68f, 21.66f, 12.42f, 24.78f, 17.76f, 23.94f, 11.04f, 19.92f, 7.74f, 19.02f,75.0f, 36.0f, 93.0f, 45.0f, 120.0f, 105.0f, 84.0f, 126.0f, 51.0f, 117.0f,20.0f
...
float evaluate_terrain_height(float x, float y) {
	...
	z *= noise * parameters.terrain_height;
...
void deform_terrain(mesh& m, terrain_parameters parameters)
{
	...
	for (int ku = 0; ku < N; ++ku) {
		for (int kv = 0; kv < N; ++kv) {
			...
			float alt = evaluate_terrain_height(x, y);
