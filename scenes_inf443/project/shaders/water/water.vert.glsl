...
void main()
{
	...
	float r2=vertex_position.x*vertex_position.x+vertex_position.y*vertex_position.y;
	vec4 position = model * vec4(vertex_position.x,vertex_position.y,vertex_position.z+1.5*(atan(r2/20000-1.0f)+1)*cos(r2/8000.0+2*time), 1.0);
